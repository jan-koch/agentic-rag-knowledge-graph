...
The easiest way to get started is using our Docker setup for the databases:
...
The `.env` file is already created with Docker database URLs. You only need to add your API keys:
...
If you used the Docker setup, here are useful commands:
